...
const links = [
  { label: "Acheter", to: "/recherche", search: { transaction: "vente" } },
  { label: "Louer", to: "/recherche", search: { transaction: "location" } },
  { label: "Vendre", to: "/dashboard", search: {} },
  { label: "Toutes les annonces", to: "/recherche", search: {} },
];
    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4">
      <div
        className={`mx-auto flex max-w-7xl items-center gap-4 rounded-2xl px-4 py-3 transition-all sm:px-6 ${
          dark ? "bg-card/95 shadow-soft backdrop-blur-xl" : "glass-panel"
        }`}
      >
        ...
        <div className="ml-auto hidden items-center gap-3 lg:flex">
          ...
          <Link
            to={user ? "/annonces/nouvelle" : "/auth"}
